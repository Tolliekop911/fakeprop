...
// Prices with promo pricing (show higher crossed out, real lower price)
...
const PropPrograms = () => {
  ...
  const columns = isTwoStep ? 4 : 3; // includes the left label column
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl lg:text-5xl font-heading font-bold mb-4">
            <span className="text-foreground">Still Not Sure?</span>{" "}
            <span className="text-primary">Check out our plans</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            Choose the evaluation based on your preference to become a Qualified Trader.
          </p>
        </div>
          ...
          <div className="bg-card border-2 border-primary/30 rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="inline-flex flex-wrap items-center justify-center gap-x-6 gap-y-2 bg-muted/20 border border-border rounded-2xl px-6 py-4">
                  ...
                  <div className="text-foreground font-heading font-semibold flex items-center gap-2">
                    {isHalfway && price?.upfront != null && price?.deferred != null ? (
                      <>
                        Price:{" "}
                        <span className="text-muted-foreground line-through text-sm">${price.promo.toFixed(2)}</span>
              ...
              <div className="text-center mt-8">
                <div className="mb-4">
                  <span className="text-muted-foreground line-through text-lg">${price?.promo.toFixed(2)}</span>
                </div>
                <button
